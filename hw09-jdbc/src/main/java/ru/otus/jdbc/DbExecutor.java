...
public interface DbExecutor {
    ...
    <T> Optional<T> executeSelectById(Connection connection, String sql, Object id, Function<ResultSet, T> rsHandler) throws SQLException;

    <T> Collection<? extends T> executeSelect(Connection connection, String sql, List<Object> params,
